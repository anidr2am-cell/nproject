...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
  ...
  Future<void> _deleteListing() async {
    ...
    try {
      ...
      // 2. Firestore에서 삭제
      await FirebaseFirestore.instance.collection('listings').doc(_listing.id).delete();
              ...
              : Row(
                  children: [
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(_listing.sellerNickname, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        const Text('판매자', style: TextStyle(color: muted, fontSize: 12)),
                      ],
                    ),
                    const Spacer(),
                    FilledButton(
